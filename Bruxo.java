...
public class Bruxo extends Personagem{
    ...
    public Bruxo(int saude, int energia, int forca, int habilidade, int defesa, boolean meuTurno) {
        this.saude = saude;
    ...
    public void criacaoDePersonagem(Scanner sc){
        ...
        Pocao pocaoCura = new Pocao(1, "Andorinha", "Restaura sua saude em 50 pts", 3, 1, 50);
    ...
    public void usarHabilidade(Monstro monstro, Scanner sc){
        ...
        System.out.println("*** 1) IGNI - Incendeia o inimigo                         - Custa 20 energia ***");
        System.out.println("*** 2) AARD - Derruba o inimigo e atordoa por uma rodada  - Custa 20 energia ***");
        System.out.println("*** 3) AXII - O Inimigo desfere um ataque a ele mesmo     - Custa 20 energia ***");
