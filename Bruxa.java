...
public class Bruxa extends Monstro{
    ...
    public Bruxa(String nome, int saude, int energia, int forca, int habilidade, int defesa, int x, int y) {
        this.nome = nome;
        this.saude = saude;
    ...
    public void drop(Personagem personagem){
        ...
        Pocao elixirBruxa = new Pocao(7, "Elixir de Bruxa Aquatica", "Aumenta sua forca em 4 pontos", 3, 3, 4);
        Pocao pocaoCura2 = new Pocao(8, "Pocao de cura", "Restaura sua saude em 60 pts", 3, 1, 60);
        itensDrop.add(elixirBruxa);
        itensDrop.add(pocaoCura2);

        if (personagem instanceof Mago){
            Armadura tunicaVelha = new Armadura(9, "Tunica Velha", "Aumenta a sua Defesa", 2, 5);
            itensDrop.add(tunicaVelha);
        ...
        if (personagem instanceof Guerreiro){
            Armadura armaduraNilfgaardiana = new Armadura(9, "Armadura Nilfgaardiana", "Aumenta a sua Defesa", 2, 5);
            itensDrop.add(armaduraNilfgaardiana);
        ...
        if (personagem instanceof Bruxo){
            Armadura armaduraGato = new Armadura(9, "Armadura da Escola Do Gato", "Aumenta a sua Defesa", 2, 5);
            itensDrop.add(armaduraGato);
