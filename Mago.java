...
public class Mago extends Personagem{
    ...
    public Mago(int saude, int energia, int forca, int habilidade, int defesa, boolean meuTurno) {
        this.saude = saude;
    ...
    public void criacaoDePersonagem(Scanner sc){
        ...
        Arma espadaCurta = new Arma(2, "Livro de Feiticos", "Aumenta o dano que voce causa nos inimigos", 1, 1, 3);
    ...
    public void usarHabilidade(Monstro monstro, Scanner sc){
        ...
        System.out.println("*** 1) Tempestade de Gelo - Causa dano e congela o inimigo por uma rodada - Custa 15 energia ***");
        System.out.println("*** 2) Tempestade de Fogo - Queima o inimigo                              - Custa 15 energia ***");
        System.out.println("*** 3) Recarregar Energia - Restaura 10 de energia                        - Custa  0 energia ***");
